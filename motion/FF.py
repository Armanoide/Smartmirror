...
while (1):
    ...
    mask2 = cv2.inRange(hsv, np.array([5, 54, 37]), np.array([36, 255, 255]))
    #mask2 = cv2.inRange(hsv, np.array([2, 50, 20]), np.array([15, 255, 255]))
    ...
    cv2.imshow("dilation3", dilation2)
    kernel_ellipse = cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (5, 5))
    dilation3 = cv2.dilate(filtered, kernel_ellipse, iterations=1)
    cv2.imshow("dilation4", dilation3)
